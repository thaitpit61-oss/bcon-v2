        ...
        onFinish={async (values) => {
          try {
            ...
            if (!res.ok || !json?.success) {
              message.error(json?.message || "Thêm nghề nghiệp thất bại");
              return false;
            }

            message.success("Thêm nghề nghiệp thành công");
            setOpenCreate(false);
            form.resetFields();
            actionRef.current?.reload();
            return true;
          } catch (e) {
            message.error("Lỗi mạng khi thêm nghề nghiệp");
            return false;
          }
        }}
      >
        ...
        <ProFormText
          ...
          rules={[{ required: true, message: "Vui lòng nhập tên nghề nghiệp EN" }]}
        />
      </ModalForm>
      <ProList<profession>
        actionRef={actionRef}
        ...
        showActions="hover"
        split
        headerTitle="Danh sách nghề nghiệp"
